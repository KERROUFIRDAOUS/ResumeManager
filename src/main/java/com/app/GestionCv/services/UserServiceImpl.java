...
import com.app.GestionCv.model.Role;
import com.app.GestionCv.model.User;
import com.app.GestionCv.repositories.UserRepository;
...
public class UserServiceImpl implements UserService{
	...
	public User save(UserRegistrationDto registrationDto) {
		User user = new User(registrationDto.getFirstName(),registrationDto.getLastName(),registrationDto.getEmail(),
				passwordEncoder.encode(registrationDto.getPassword()), registrationDto.getSousCategories(),registrationDto.getCategorie(),
